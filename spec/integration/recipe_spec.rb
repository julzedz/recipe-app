...
RSpec.describe 'recipes/index.html.erb', type: :view do
  describe 'integration tests for recipes page' do
    before(:each) do
      @user = User.create(name: 'Elijah', email: 'vitoesie@gmail.com', password: '123456')
      # Assuming you have set up Devise test helpers or similar, you can use sign_in to simulate user authentication.
      sign_in @user

      @recipe1 = Recipe.create(name: 'Julian', user_id: @user.id, preparation_time: 43, cooking_time: 54,
                               description: 'test recipe 1', public: true)
      @recipe2 = Recipe.create(name: 'tea', user_id: @user.id, preparation_time: 43, cooking_time: 54,
                               description: 'test recipe 2', public: true)
      @recipe3 = Recipe.create(name: 'pizza', user_id: @user.id, preparation_time: 43, cooking_time: 54,
